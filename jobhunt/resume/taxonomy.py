...
This is intentionally broad (tech, education, healthcare, trades, business)
so the app works for anyone, not just software engineers. Matching is
case-insensitive on word boundaries; multi-word entries are matched as
phrases. Users effectively extend this list implicitly: anything listed
under a resume's own "Skills" section is also captured verbatim.
"""
...
# Certification patterns recognized anywhere in the resume (beyond an
# explicit Certifications section). Kept as plain phrases; matching is
# case-insensitive.
